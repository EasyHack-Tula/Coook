...
function Recipe_Breakfast_1_1(props) {
    ...
    return (
        ...
        <div>
            ...
            <div className="Container">
                ...
                <DelayLink delay={2000} to="./Recipe_Breakfast_1_2" replace={false}><div className="Button" onClick={() => {setIsShow(true); setTimeout(() => {setIsShow(false);},1500)}}> Продолжить </div></DelayLink>
...
export default Recipe_Breakfast_1_1
